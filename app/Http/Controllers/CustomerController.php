...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->search) {
            $customers = User::where('role', 1)->where(DB::raw("concat(fname, ' ', lname)"), 'LIKE', '%' . $request->search . '%')
                ...
                ->orWhere('custom_id', $request->search)->where('isVIP',0)
                ->latest()->paginate(12);
        } else {
            $customers = User::where('role', 1)->where('isVIP',0)->latest()->paginate(12);
        }

        $VIP_customers=User::where('isVip', 1)->latest()->paginate(12);
        ...
        return view('backend.customer.index', compact('page_title', 'customers', 'data','VIP_customers'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(Auth::user()->id ==1){
            ...
            return redirect()->route('customer.list')->with('error', translate('You have no permission!'));
        }
    ...
    public function upgrade(Request $request, $id)
    {
        ...
        return redirect()->route('customer.list')->with('success', translate('Customer has been Upgraded successfully'));
    }
    ...
    public function downgrade(Request $request, $id)
    {
        ...
        return redirect()->route('customer.list')->with('success', translate('Customer has been downgrded successfully'));
    }
    ...
    public function changeStatus()
    {
        ...
        if(Auth::user()->id ==1){
            return redirect()->with('error', translate('You have no permission!'));
        }
