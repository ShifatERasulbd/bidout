...
class PageController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            if(Auth::user()->id ==1){
                ...
                return  response()->json(['status' => false, 'message' => translate('You have no permission!')]);
    ...
    public function changeStatus()
    {
        ...
        if(Auth::user()->id ==1){
            $response = array('output' => 'success', 'statusId' => $status, 'pageId' => $pageId, 'message' => 'You have no permission!', 'active' => translate('Active'), 'inactive' => translate('Inactive'));
