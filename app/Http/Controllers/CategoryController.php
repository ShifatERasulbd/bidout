...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if(Auth::user()->id ==1){
            ...
            return redirect()->route('category.list')->with('error', translate('You have no permission!'));
          }
    ...
    public function changeStatus()
    {
        if(Auth::user()->id ==1){
            ...
            $response = array('output' => 'success', 'statusId' => '', 'catId' =>'', 'message' =>'You have no permission!', 'active' => translate('Active'), 'inactive' => translate('Inactive'));
