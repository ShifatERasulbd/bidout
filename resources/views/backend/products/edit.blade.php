                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 auction_type">
                                    ...
                                    @enderror
                                       ...
                                       <div class="row">
                              <div class="col-xl-6 auction_type">
                                    <div class="form-inner mb-35">
                                        <label>{{ translate('Bidding Price 1') }} <span
                                                class="text-danger">*</span></label>
                                        <div class="input-with-btn style2 d-flex jusify-content-start align-items-strech">
                                            <input type="text" placeholder="0.00" name="add_balance_one"
                                                value="{{ $productSingle->add_balance_one }}">
                                 ...
                                 <div class="col-xl-6 auction_type">
                                    <div class="form-inner mb-35">
                                        <label>{{ translate('Bidding Price 2') }} <span
                                                class="text-danger">*</span></label>
                                        <div class="input-with-btn style2 d-flex jusify-content-start align-items-strech">
                                            <input type="text" placeholder="0.00" name="add_balance_two"
                                               value="{{ $productSingle->add_balance_two }}">
                                 ...
                                 <div class="col-xl-6 auction_type">
                                    <div class="form-inner mb-35">
                                        <label>{{ translate('Bidding Price 3') }} <span
                                                class="text-danger">*</span></label>
                                        <div class="input-with-btn style2 d-flex jusify-content-start align-items-strech">
                                            <input type="text" placeholder="0.00" name="add_balance_three"
                                                value="{{ $productSingle->add_balance_three }}">
                                 ...
                                 <div class="col-xl-6 auction_type">
                                    <div class="form-inner mb-35">
                                        <label>{{ translate('Bidding Price 4') }} <span
                                                class="text-danger">*</span></label>
                                        <div class="input-with-btn style2 d-flex jusify-content-start align-items-strech">
                                            <input type="text" placeholder="0.00" name="add_balance_four"
                                                value="{{ $productSingle->add_balance_four }}">
