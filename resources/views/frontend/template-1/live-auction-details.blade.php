...
@section('content')
    ...
    <div class="auction-details-section pt-120">
                            ...
                            <div class="bid-form">
                                ...
                                @if ($auction_details->start_date < now())
                                    <form action="{{ route('live.auction.checkout.check') }}" method="POST">
                                        ...
                                        <div class="form-inner gap-2">
                                            ...
                                            <input type="number" step="any"
                                                ...
                                                name="price"  id="my_input"
                                                value="{{ ($latest_bid->bid_amount ?? $auction_details->min_bid_price) + 1 }}"
                                                required>
                                    ...
                                    <div style="margin-top:5px">
                                        <a href="#" class="btn btn-primary" onclick="addValue({{ $auction_details->add_balance_one}}); return false;">  {{ $auction_details->add_balance_one}}</a> 
                                        <a href="#" class="btn btn-primary" onclick="addValue({{ $auction_details->add_balance_two}}); return false;">    {{ $auction_details->add_balance_two}}</a> 
                                        <a href="#" class="btn btn-primary" onclick="addValue({{ $auction_details->add_balance_three}}); return false;"> {{ $auction_details->add_balance_three}}</a> 
                                        <a href="#" class="btn btn-primary" onclick="addValue({{ $auction_details->add_balance_four}}); return false;"> {{ $auction_details->add_balance_four}}</a> 
                ...
                <div class="col-lg-8">
                    <ul class="nav nav-pills d-flex flex-row justify-content-start gap-sm-2 gap-3 mb-45 wow fadeInDown"
                        ...
                        @if ($specifications->count() > 0)
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active details-tab-btn" id="pills-specification-tab"
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-specification" role="tabpanel"
      ...
      <script>
                                                ...
                                                const value = document.getElementById('my_input').value;
                                                alert("Form submitted with value: " + value);
                                                // You can return false to prevent actual submission for testing
                                                return false;
                                                }
                                            </script>
@endsection
